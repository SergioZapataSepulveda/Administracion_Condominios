<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PagarGastosComunes.aspx.cs" Inherits="WebCaso14.index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    <div id="Titulos">
		Cuotas Gastos Comunes
	</div>
					...
					<table style="width: 100%;" class="tablaFijada">
	                        <tr>
								<td style="width: 65%;" class="textoDestacado" >
	                                <b><asp:Label ID="Label9" runat="server" Text="Listado de cuotas de mis gastos comunes "></asp:Label><br>
								</td>
                                <td style="width: 5%;"><br>
                                </td>
                   ...
                   <table style="width: 100%;" class="tablaFijada">
	                    <tr>
							<td style="width: 65%;">
                             ...
                             <td style="width: 30%;" >
                                    <b><asp:Label ID="Label4" runat="server" Text="Seleccione una cuota para poder pasar a las opciones de pago, alli encontrara:"></asp:Label></b>
                                    ...
                                    <br><br><br>
	                                <asp:Label ID="Label3" runat="server" Text="Id cuota seleccionada: "></asp:Label>
                                    <b><asp:Label ID="lbl_selccion_ID" runat="server" Text=" - nada seleccionado -  "></asp:Label></b><br>
                                    <asp:Label ID="Label1" runat="server" Text="Monto cuota seleccionada: "></asp:Label>
                                    <b><asp:Label ID="lbl_selccion_Monto" runat="server" Text=" - nada seleccionado -  "></asp:Label></b><br>
                                    <asp:Label ID="Label2" runat="server" Text="Fecha Termino seleccionada: "></asp:Label>
                                    <b><asp:Label ID="lbl_selccion_fecha" runat="server" Text=" - nada seleccionado -  "></asp:Label></b><br>
                                    <asp:Label ID="Label5" runat="server" Text="Estado cuota seleccionada: "></asp:Label>
