<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="AdjuntarBoletaOffline.aspx.cs" Inherits="WebCaso14.ingresoResidentes" %>
            ...
            <tr>
                <td style="width: 57%; padding: 15px">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 50%;">
                                <asp:Label ID="Label1" runat="server" Text="Seleccionar el tipo de pago al cual adjuntara pago offline  "></asp:Label>
