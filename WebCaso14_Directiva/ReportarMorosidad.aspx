<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReportarMorosidad.aspx.cs" Inherits="WebCaso14_Directiva.ReportarMorosidad" %>
					...
					<table style="width: 100%;">
	                        <tr>
								<td style="width: 70%;" class="textoDestacado" >
	                                <b><asp:Label ID="Label2" runat="server" Text="Ver Detalle Gasto Comun y Morosidad Por Residente"></asp:Label><br>
								</td>
                                <td style="width: 2%;"><br>
                                </td>
                                <td style="width: 27;" class="textoDestacado" >
	                                <b><asp:Label ID="Label4" runat="server" Text="Ingresar Reporte Morosidad"></asp:Label></b>
								</td>
							</tr>
					</table>
						...
						<tr>
                            ...
                            <asp:GridView ID="GridView2" runat="server" 
                             ...
                             <td style="width: 28%;" >
                                ...
                                <asp:Button ID="Modificar_Registro" runat="server" Text="Reportar Morosidad" onclick="Modificar_Registro_Click" /><br>
