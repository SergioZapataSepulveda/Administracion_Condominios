<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginDirectiva.aspx.cs" Inherits="WebCaso14_Directiva.LoginDirectiva" %>
...
<body style="background: linear-gradient(to right, #f6f1d3, #648880, #293f50);">
    <br /><br /><br /><br />
                <div id="AccesoPorLogin"  style="width: 450px; height: 250px; margin-left: auto; margin-right: auto; background-color: white; font-family: arial; ">
                    <asp:Label ID="Label1" runat="server" style="margin-top: -40px; position: absolute; font-family: Arvo; font-weight: 700; color: White; font-size: 30px;" Text="Acceso para Directiva"></asp:Label>
