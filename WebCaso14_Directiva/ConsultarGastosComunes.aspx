<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConsultarGastosComunes.aspx.cs" Inherits="WebCaso14_Directiva.ConsultarGastosComunes" %>
				...
				<td style="width: 57%; padding:15px">
	                ...
	                <tr>
							<td class="textoDestacado">
								<b><asp:Label ID="Label9" runat="server" Text="Consultar Gastos Comunes"></asp:Label></b>
							</td>
						</tr>
