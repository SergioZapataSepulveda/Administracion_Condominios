<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReservarAreasComunes.aspx.cs" Inherits="WebCaso14_Administrador.ReservarAreasComunes" %>
        ...
        <tr>
            <td style="width: 57%; padding: 15px">
                <table style="width: 100%;">
                    <tr>
                        <td class="textoDestacado">
                            <b>
                                <asp:Label ID="Label1" runat="server" Text="Elegir fecha para Reserva "></asp:Label>
                        </td>
                    </tr>
                </table>
                <table style="width: 100%;">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 50%;">
                            <asp:Label ID="Label9" runat="server" Text="Ingrese Rut Residente al cual <br/>se le va a asignar la reserva: "></asp:Label><br/>
                            <asp:TextBox ID="txt_rutReserva" runat="server"></asp:TextBox><br/>
                            <asp:Button ID="btn_validarRut"
                                runat="server" Text="Validar Rut" onclick="btn_validarRut_Click" />
                            <asp:Button ID="btn_calcular_costo" runat="server" Text="Calcular Costo" 
                                onclick="btn_calcular_costo_Click" />
                                <br/>
                            <asp:Label ID="lbl_RutValidar" runat="server" Text="---"></asp:Label>
                        </td>
                        <td style="width: 30%;">
                        ...
                        <td style="width: 20%;">
                            <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Portal de Pago" /><br />
                            <br />
                        </td>
                    </tr>
                </table>
